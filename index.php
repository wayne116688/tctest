...
function createSignedCookie($streamHostUrl, $resourceKey, $timeout){
    $keyPairId = "K2TVSWUDNGU2TW"; // Key Pair
...
<body>
  <h2>Cookie Detailes </h2>
    ...
    <?php
    $signedCookieCustomPolicy = createSignedCookie('https://stream.wildlion.site', 'd5a58e98-41e6-472d-903a-539261c26119/AppleHLS1/*', 300);
    foreach ($signedCookieCustomPolicy as $name => $value) {
        setcookie($name, $value, 0, "/", "stream.wildlion.site", false, false);
    }
...
<h2> Testing Signed Cookie On HLS Stream</h2>
  <div id="player"></div>
  <script>
    var player = new Clappr.Player({source: "https://stream.wildlion.site/d5a58e98-41e6-472d-903a-539261c26119/AppleHLS1/2.m3u8", autoPlay: true, parentId: "#player"});
  </script>
</body>
</html>